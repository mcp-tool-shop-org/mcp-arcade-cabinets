...
**भूतिया मेनू** एक छोटा रेट्रो शूटर गेम है। आप मैदान के नीचे एक जहाज उड़ाते हैं। आपके ऊपर, एक एमसीपी सर्वर और एक एजेंट के बीच की रिकॉर्ड की गई लड़ाई लहरों के रूप में दिखाई देती है: अभिवादन, मेनू, कॉल, जवाब, और एक बॉस जो स्वयं प्रयोग है।
...
- **बॉस प्रयोग हैं, आरोप नहीं।** व्हिस्परर, मेनू और डोरमैन अपनी लहर के लिए आते हैं, चाहे कुछ भी गलत हो या न हो। वे एक एजेंट की तरह सोचते हुए बड़बड़ाते हैं। हार्डकोर में एक लैंप और पहली गोली से ही क्रोध होता है। सीट, लाइव और हार्डकोर में थोड़े **समानांतर** विस्फोट होते हैं जो मैदान को बढ़ाते हैं और संगीत को तीव्र करते हैं, फिर जैसे-जैसे दौर आगे बढ़ता है, वे लंबे समय तक चलते हैं। स्थानीय रूप से, आप एक ओलामा मॉडल को बॉस की गोली चलाने दे सकते हैं - यह कभी नहीं देखता कि कौन से स्प्राइट झूठ हैं।
- **संकेत क्रम में होते हैं।** एक झूठ कभी भी अपने ईमानदार समकक्ष से अलग तरीके से नहीं दिखता, नहीं हिलता या नहीं आता। जो इसे उजागर करता है, वह यह है कि यह कहां है: एक अतिरिक्त संरचना, एक दूसरा मेनू, मेनू के ठीक बाद एक अकेला।
...
सूची से एक टेप चुनें। प्रत्येक को फिक्स्चर, सीट या लाइव के रूप में लेबल किया गया है; कारण जानने के लिए **i** पर होवर करें। सीट डिफ़ॉल्ट लड़ाई है। लाइव का मतलब है कि इसे जीवित रहना चाहिए। हार्डकोर चौथा स्तर है, जो केवल चयनकर्ता से उपलब्ध है।
...
[हैंडबुक](https://mcp-tool-shop-org.github.io/mcp-arcade-cabinets/handbook/) बाकी मैनुअल है: संकेत, बॉस, कठिनाइयाँ और गेम कैसे बनाया गया है। क्या भेजा गया था, और कब, यह [चेंजलॉग](CHANGELOG.md) में है। गेम क्या छूता है, यह [SECURITY.md](SECURITY.md) में है।
