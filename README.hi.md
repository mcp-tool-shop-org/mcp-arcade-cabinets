...
**mcp-arcade-cabinets** एक आर्केड गेम है। प्रत्येक कैबिनेट एक छोटा गेम है जो एक ही चेसिस पर बनाया गया है: यह **टेप** पढ़ता है, यानी उन रिकॉर्डिंग को जो [mcp-arcade](https://github.com/mcp-tool-shop-org/mcp-arcade) एक एमसीपी सर्वर और एक एजेंट के बीच हुए मुकाबले की रिकॉर्ड करता है, और उन्हें एक ऐसे गेम में बदल देता है जिसे आप खेल सकते हैं। एक कैबिनेट कभी भी सर्वर से बात नहीं करता, कभी भी कोई रसीद लोड नहीं करता, और कभी भी ऐसा स्कोर नहीं रखता जिसे उपकरण देख सके। आप हमेशा मॉडल होते हैं; गेम इस बात में भिन्न होते हैं कि रिग आपसे क्या करने के लिए कहता है।
...
| ---------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[मेन्यू में भूत](packages/ghost-on-the-menu/README.md)** | एक छोटा रेट्रो शूटर गेम। रिग आपको संकेत देता है; एजेंट को जिन संकेतों को नहीं देना चाहिए था, वे ईमानदार संकेतों के बीच छिपे होते हैं और हिट पर प्रकट होते हैं। बॉस प्रयोग हैं, और एक स्थानीय मॉडल उनमें बैठ सकता है। | जारी किया गया, `v0.9.0`। [खेलें](https://mcp-tool-shop-org.github.io/mcp-arcade-cabinets/play/) · `npx @mcptoolshop/ghost-on-the-menu` · [डॉकर](https://github.com/mcp-tool-shop-org/mcp-arcade-cabinets/pkgs/container/mcp-arcade-cabinets) |
| **[वाइब टाइपर](packages/vibe-typer/README.md)**            | एक टाइपिंग आर्केड गेम। आप एक मेहनती, चापलूस कोडिंग एजेंट हैं; आपका उपयोगकर्ता एक वाइब कोडर है जिसके अनुरोध बेतुके हैं। कोड टाइप करें, देखें कि चीज़ कैसे बनती है, और मूल्यांकन बढ़ता है। स्तर, अंतहीन, कठिन।         | जारी किया गया, `v0.9.0`। [खेलें](https://mcp-tool-shop-org.github.io/mcp-arcade-cabinets/play/) · `npx @mcptoolshop/ghost-on-the-menu` · [डिजाइन और लॉक](docs/vibe-typer.dispatch.md)                                                        |
| **House Call**                                             | एक टर्न-आधारित कैलिब्रेशन गेम: एक संकेत और आत्मविश्वास बताएं, फिर टेप बताता है कि क्या हुआ।                                                                                                                          | जब तक कि ऐसा डिज़ाइन न हो जो गेम चला सके, तब तक इसे रोक दिया गया है। `tape-core` अपने स्कोरिंग नियमों को बनाए रखता है।                                                                                                                       |

अधिक कैबिनेट यहां आएंगे। प्रत्येक का अपना पैकेज, हैंडबुक में अपना पृष्ठ और इस तालिका में अपनी पंक्ति होगी।

## प्रत्येक कैबिनेट में क्या समान है

- **टेप अंदर, कुछ भी बाहर नहीं।** `packages/tape-core` `mcp-arcade.tape/v1` लोड करता है, किसी भी चीज़ को अस्वीकार करता है जिसमें स्कोर या निर्णय होता है, और गेम हेडर शब्द, वायर पंक्तियाँ और प्रति परमाणु एक बंद तथ्य प्रदान करता है। बीस रिकॉर्डिंग `fixtures/tapes/` में जारी की जाती हैं।
- **एक हेडलेस सिम और एक पतला शेल।** प्रत्येक गेम एक शुद्ध, सीडेड सिमुलेशन है जिसमें एक स्क्रिप्टेड प्ले-थ्रू और एक निष्पक्षता बैंड होता है जो निर्माण को विफल कर देता है। `apps/cabinets` ब्राउज़र शेल है जो उन्हें माउंट करता है और यह वही है जो पेज `/play/` पर प्रदान करता है।
...
- **एक मॉडल के लिए एक सीट, एक गेट के पीछे।** एक स्थानीय या क्लाउड मॉडल एक कैबिनेट में बैठ सकता है (भूत में एक बॉस, वाइब टाइपर के अंतहीन मोड में उपयोगकर्ता)। यह केवल एक बंद सेट से एक लीवर भरता है, इसकी लिखी प्रत्येक पंक्ति एक शब्द गेट से गुजरती है, और क्षेत्र में कुछ भी इसका नाम नहीं बताता है। एक कैबिनेट stdio पर एक एमसीपी सर्वर के रूप में भी चल सकता है, इसलिए एक एजेंट वह हो सकता है जो खेल रहा है।
- **एक आवाज।** एक होस्ट-साइड वर्कर (`voice/`) उन पंक्तियों को बोलता है जिन्हें एक गेट ने स्वीकार किया है, [fx-dub](https://github.com/mcp-tool-shop-org/fx-dub) द्वारा उन्हें खेलने से पहले।
...
ब्राउज़र में: [`/play/`](https://mcp-tool-shop-org.github.io/mcp-arcade-cabinets/play/)। पृष्ठ दोनों कैबिनेटों के बीच एक स्विच पर खुलता है और याद रखता है कि आपने पिछली बार कौन सा गेम खेला था। प्रकाशित पृष्ठ में कोई डेमॉन नहीं है, इसलिए मॉडल और आवाज सीटें वहां अनुपस्थित हैं।
...
यह शेल, दोनों कैबिनेटों को `127.0.0.1` पर परोसता है और इसे खोलता है; `--mcp` भूत को मेनू को stdio पर एक एमसीपी सर्वर के रूप में चलाता है। नोड 22 या नया। एक पैकेज npm पर प्रकाशित होता है और यह वही है; यहां प्रत्येक अन्य पैकेज निजी है।
