...
- **The music** is a playlist. A piece runs from its first bar to its last, the next is drawn with no repeats until every one has been heard, and nothing on the field replaces it: not a wave, not a boss, not the scene between two tapes. Beds sit under the shots and the catch; mute pauses the piece and everything else with it. A shift carries the music through its cards.
