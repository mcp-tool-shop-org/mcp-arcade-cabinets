...
En algún lugar de esa secuencia se encuentran las comunicaciones que el agente no debería haber realizado. Parecen cualquier otra cosa hasta que te encuentras con una. A partir de ese momento, te pertenece durante el resto de la ronda.
...
- **La escena final** nombra la cinta, el servidor y la política. Las mentiras detectadas se muestran como trofeos. Las que escapan permanecen en su forma original. No hay puntuación, ni recuento, ni dígito.

Elige una cinta de la lista. Cada una está etiquetada como "fixture", "seat" o "live"; pasa el cursor sobre la **i** para obtener más información. "Seat" es el modo de combate predeterminado. "Live" está diseñado para que se pueda superar. "Hardcore" es el cuarto nivel, accesible solo desde el selector.
