...
Grok's order was shipped first (the three line defects, the cap, the shooters unchanged, the reader bot with a gun and a memory, the seat reader bar split, the beds cut on meaning). The Director played it and called it too thin and boring, and hardcore weak; that read stands over the consult's caution about the classes, because the feel is his and the band's bots do not dodge. The tune that shipped after it: every class fires at seat, live and hardcore, on the way in, the first shot at three tenths of a period (a fifth at hardcore is instant death on one lamp and was pulled back to a half), the ship holding three shots at seat and live and two at hardcore; hardcore's formation every 1.6 seconds with wider spread, its dive and boss faster. The band's tier-one, live, climb and hardcore bars were re-based to what the bots measure at that heat, with the reason beside each; the andon bars (the pinned lie counts, the recorded rung, the idle floor, the leak scan) stand. The three line defects and the cap stay as the consult named them. Question two remains the open one: a reader bot that represents a person's ceiling under rain does not exist yet, and until it does the human bar is the Director's play.
