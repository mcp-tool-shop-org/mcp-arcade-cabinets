...
## What was set after the consult was drafted

The Director played setting C and called it too thin. Seat is now set at K: every class fires, on entry, `firstShot` 0.4, three ship shots in the air. Live takes I's list (grid, menu, ready, answer, hover only, `firstShot` 0.4); hardcore keeps the shipped numbers. Under K a sweeping player who never dodges loses a seat round in about thirty-five seconds and sees seven to twelve formation shots before the boss; the reader bot lives out no seated tape. Two seat bars were re-based on the measured numbers (every lie on eleven of twenty seated tapes and half the lies overall; a lie found on a third of the roster at the top of the climb). The questions below stand, and question 2 is now urgent: the reader bot is the wrong instrument at this heat.
