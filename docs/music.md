...
- The change hold is the whole piece (`changeHold`, capped at `BED_MAX_S`); a boss bed comes at once and starts from its `entry`; the opening is a seeded pool draw.
