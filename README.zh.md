...
| **[Vibe Typer](packages/vibe-typer/README.md)**               | 一款打字街机游戏。你是一个勤奋、谄媚的编码智能体；你的用户是一个氛围编码师，他的要求非常荒谬。输入代码，观察程序被构建，然后评估结果。关卡、无限、高难度。 | 已发布，`v0.9.0`。[试玩](https://mcp-tool-shop-org.github.io/mcp-arcade-cabinets/play/) · `npx @mcptoolshop/vibe-typer` · [设计和锁定](docs/vibe-typer.dispatch.md)                                                                    |
