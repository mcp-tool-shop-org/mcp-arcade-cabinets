...
4. **The music** was reworked on the Director's play notes (a bed holds at least a minute, then crossfades into the playing wave's bed; bursts as an overlay; a fade at the scene). With **Voice** on every boss speaks its authored spawn line, so the voice is audible without a seat. The Director hears it again; the `poison`, `rug`, `unlisted` and `breather` beds are no longer picked by the shell (the boss beds carry their waves) and are the Director's to reassign or retire.
