...
4. **The music** was reworked on the Director's play note (one bed per wave, kept through breathers, bursts as an overlay, crossfades, a fade at the scene). The Director hears it again; the `poison`, `rug`, `unlisted` and `breather` beds are no longer picked by the shell (the boss beds carry their waves) and are the Director's to reassign or retire.
